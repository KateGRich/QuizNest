...
namespace QuizNestMVC.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(ILogger<HomeController> logger,
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    try
                    {
                        ...
                        var user = _userManager.GetUserByUserID(_accessToken.UserID);
                        if(user.Active == false)
                        {
                            // Their account is not active - don't let them sign in.
